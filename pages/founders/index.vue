...
useHead({
  title: "Фаундеры | Энерготехнохаб Петербург",
  meta: [
    {
      name: "description",
      content:
...
const mockCards = [
  {
    text: "Имеют прямой выход на бизнес-заказчиков в нефтегазовой отрасли",
  },
  {
    text: "Работают с трекерами, менторами и экспертами отрасли",
  },
  {
    text: "Пилотируют технологии на реальных промышленных объектах энергетического сектора",
  },
  {
...
const breakpoints = [
  {
    title: "Подайте <br /> заявку",
    info: "Заполните регистрационную форму",
  },
  {
    title: "Пройдите <br /> интервью",
    info: "Дождитесь личного собеседования со специалистом «Энерготехнохаба Петербург» и расскажите о своем опыте",
  },
  {
    title: "Защитите <br /> проект",
    info: "Проработайте идею вместе со специалистами экосистемы и проведите питч перед экспертной комиссией",
  },
  {
    title: "Подпишите <br /> соглашение",
    info: "В случае успешной защиты подпишите соглашение о сотрудничестве с «Энерготехнохаб Петербург»",
  },
];
...
<template>
  ...
  <section class="section-margin">
    <div class="container">
      ...
      />
      <SharedBreakPoints :points="breakpoints" />
    </div>
  </section>
  <section class="section-margin">
    <div class="container">
